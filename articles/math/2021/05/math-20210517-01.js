MultipePlatformBlogData.register(doc => {
    ...
    doc.body(
        ...
        , h5("7.")
        , p("5,6 の証明、④より")
        , p(textCenter, tex("m_2^2x^2+m_1^2y^2 = z^2"))
        , p(textCenter, tex("(m_2x±m_1y)^2 = z^2 ± 2m_1m_2xy = z^2 ± 4m_3^2n"))
        , p("ここで、もし", tex("z, n"), "が奇素数", _p, "を共通の約数に持つとすると、"
            , "上の式から", tex("m_2x±m_1y"), "も", _p, "を共通の約数に持つが、"
            , tex("m_2x±m_1y"), "は互いに素なので（", link, "を参照）、矛盾が生じる。")
        , p("（証明終）")
    )
})
